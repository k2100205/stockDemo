    ...
    */
    (function (rating) {
        ...
        var wijrating = (function (_super) {
            ...
            wijrating.prototype._innerDisable = function () {
                var o = this.options, resetButton = $("." + o.wijCSS.wijratingResetButton, this.ratingElement[0]);
            ...
            wijrating.prototype._innerEnable = function () {
                var o = this.options, resetButton = $("." + o.wijCSS.wijratingResetButton, this.ratingElement[0]);
            ...
            */
            ...
            wijrating.prototype._createRating = function () {
                ...
                if (o.resetButton.disabled || this._isDisabled()) {
                    resetButton.hide();
        ...
        if ($.mobile && $.mobile.selectmenu && $.mobile.selectmenu.initSelector) {
