    ...
    (function (_menu) {
        ...
        var wijmenu = (function (_super) {
            ...
            wijmenu.prototype._createMenuItems = function () {
                ...
                if (o.ensureSubmenuOnBody && o.mode === "flyout") {
                    ...
                    itemContainer = $("<ul>").addClass(o.wijCSS.wijmenuList).addClass(o.wijCSS.helperReset).data(self.widgetFullName, self).data("wijmomenu", self.widgetFullName).attr("role", "menu");
                }
            ...
            */
            wijmenu.prototype.activate = function (event, item) {
                ...
                self.element.attr({
                    "aria-activedescendant": link.attr("id"),
                    "role": "menu"
                });
        ...
        var wijmenuitem = (function (_super) {
            ...
            wijmenuitem.prototype._killFlyout = function () {
                ...
                ele.removeClass(o.wijCSS.wijmenuParent).off(".wijmenuEvent").off(".wijmenuitem").children(":first").off(".wijmenuEvent").off(".wijmenuitem");
            ...
            wijmenuitem.prototype._innerDestroy = function (invokedByParent) {
                ...
                item.children("ul").removeClass(o.wijCSS.wijmenuList).removeClass(o.wijCSS.content).removeClass(o.wijCSS.cornerAll).removeClass(o.wijCSS.helperClearFix).removeClass(o.wijCSS.wijmenuChild).removeClass(o.wijCSS.helperReset).removeAttr("role").removeAttr("aria-activedescendant").show().css({ left: "", top: "", position: "" }).attr("hidden", "");
