        ...
        var wijgrid = (function (_super) {
            ...
            */
            ...
            wijgrid.prototype._handleVerticalVirtualScrolling = function (scrollIndex, forceIntersectionMode, completeCallback) {
                ...
                var view = this._view(), bounds = this._viewPortBounds(), virtualPageSize = view.getVirtualPageSize(), newBounds, renderableRowsCount = this._renderableRowsCount(), cachedDataBounds = this._ensureTotalRowsBounds({
                    start: this.mDataOffset,
                    end: this.mDataOffset + this.mDataViewWrapper.dataView().count() - 1
                }), request = null, mode;

                if (renderableRowsCount - scrollIndex < virtualPageSize && !this._hasGrouping() && !this._hasBands() && !this._hasDetail() && !this.options.showGroupArea && !this.options.showFilter) {
                    scrollIndex = renderableRowsCount - virtualPageSize;
                }
                    ...
                    this._windowResizeTimer = window.setTimeout(function () {
                        ...
                        try  {
                            if (!self.mDestroyed && self._initialized && self.element.parent().length && self.element.is(":visible")) {
                                ...
                                var resize = self.mResizeOnWindowResize && (!wijmo.grid.isAndroid() || (orientation !== self._winOrientation));
        ...
        var selection = (function () {
            ...
            */
            ...
            selection.prototype.doSelection = function () {
                var view = this._wijgrid._view(), rowInfo, prevRowIndex = -1;
