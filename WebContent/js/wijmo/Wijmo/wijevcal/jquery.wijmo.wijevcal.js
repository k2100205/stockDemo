    ...
    (function (evcal) {
        ...
        var wijevcal = (function (_super) {
            ...
            wijevcal.prototype._updateHeaderTitleText = function () {
                var self = this, o = self.options, fmt = o.titleFormat, viewStart = o.selectedDates[0], viewEnd = o.selectedDates[o.selectedDates.length - 1], viewIndex = self._getCurrentViewIndex(), isCustomView = self._isCustomView(viewIndex), viewType;
                if (isCustomView) {
                    viewType = "custom";
                } else {
                    viewType = o.viewType;
