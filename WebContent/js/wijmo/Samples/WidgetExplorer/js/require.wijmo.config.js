var wijmo;
(function (wijmo) {
    var isExplorerHtml = document.location.pathname.match(/explore\.htm/), amdJs = "../../amd-js", isOnline = document.location.host.match(/\.com/), widgetExplorerDir = "../Samples/WidgetExplorer", jsDir = widgetExplorerDir + "/js", externalDir = "http://cdn.wijmo.com/external";

    if(isOnline) {
        amdJs = "http://cdn.wijmo.com/amd-js/3.20162.103";
